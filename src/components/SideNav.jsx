    ...
    return (
      <>
        <AnimatePresence>
          {showSidebar && (
            <motion.div
              ...
              style={{ position: "fixed", bottom: 24, right: 20, zIndex: 1200 }}
            >
              <Fab
                color="primary"
                size="medium"
        ...
        >
          ...
          <Divider sx={{ mb: 2 }} />
          <Box component="nav">
            <Box sx={{ width: "fit-content", mx: "auto", display: "flex", flexDirection: "column", gap: 1 }}>
              <TocList
                items={items}
                activeId={activeId}
                onClick={handleClick}
